...
import eliswaLogo from '../assets/brand_logo.webp';
    ...
    <>
      ...
      >
        <div className={`mx-auto pointer-events-auto transition-all duration-500 bg-cream/95 backdrop-blur-md border border-vintage/15 shadow-sm flex items-center justify-between ${
          ...
          <div className="hidden md:flex items-center justify-center gap-4 lg:gap-8 text-[10px] lg:text-[11px] tracking-[0.25em] uppercase font-semibold text-[#cf958f]">
